...
struct RecipeSelectFoodSheetView: View {
    ...
    @Binding var selectedFoodsList: [String]
    @Binding var selectedFoodsAmountList: [String]
                ...
                Button(action: {
                    ...
                    DispatchQueue.main.async{
                        for food in selectedIngredients {
                            ...
                            selectedFoodsAmountList.append("")
                        }
